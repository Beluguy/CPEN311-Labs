...
task check_reuleaux (input int x, int y);
        if((x > left_circle_centre_x) && (x < right_circle_centre_x)) right_vga_plot = 1;
        else if((x >= centre_x) && (x <= right_circle_centre_x)) right_vga_plot = 1;
        else if(& (x >= left_circle_centre_x) && (x < centre_x)) right_vga_plot = 1;
