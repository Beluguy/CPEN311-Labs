...
initial begin
	...
	$readmemh("C:/Users/bryan/Downloads/CPEN311/github/CPEN311-Labs/3/task5/test1.memh",`timescale 1 ps / 1 ps
module tb_rtl_task5();
...
initial begin
	...
	SW[9:0] = 10'b0000000000;         //keys -> test1:24 (even)  test2:1 (odd)   test3:7 (odd)     Test 4 = 18 sec, Test 5 = ~7.3 min
	$readmemh("C:/Users/bryan/Downloads/CPEN311/github/CPEN311-Labs/3/task5/test1.memh",\ct|altsyncram_component|auto_generated|altsyncram1|ram_block3a0 .ram_core0.ram_core0.mem);
