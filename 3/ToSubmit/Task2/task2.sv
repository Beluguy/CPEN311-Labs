module task2(input logic CLOCK_50, input logic [3:0] KEY, input logic [9:0] SW,
		...
		always_comb begin
			case(state)
				4'd0: test_en = {2'b00, ~KEY[0]};
				4'd1: test_en = {1'b0, ~KEY[0], 1'b0};
				default: test_en = 3'b000;
			endcase
			case(state)
				4'd1: wren_reg = init_wren;
				4'd2: wren_reg = ksa_wren;
				default: wren_reg = 1'b0;
			endcase
			case(state)
				4'd1: wrdata_reg = init_wrdata;
				4'd2: wrdata_reg = ksa_wrdata;
				default: wrdata_reg = 8'b00000000;
			endcase
			case(state)
				4'd1: addr_reg = init_addr;
				4'd2: addr_reg = ksa_addr;
