...
else if((statewire == 3'b101) && (dscore == 4'b0110) && (pcard3 >= 4'b0110) && (pcard3 <= 4'b0111)) state <= 3'b110;    // 5 -> 6 (dscore = 6, pcard3 between 6,7)
else if((statewire == 3'b101) && (dscore == 4'b0110) && ~((pcard3 >= 4'b0110) && (pcard3 <= 4'b0111))) state <= 3'b111; // 5 -> 7 (dscore = 6, pcard3 not between 6,7)
else if((statewire == 3'b101) && (dscore == 4'b0101) && (pcard3 >= 4'b0100) && (pcard3 <= 4'b0111)) state <= 3'b110;    // 5 -> 6 (dscore = 5, pcard3 between 4,7)
else if((statewire == 3'b101) && (dscore == 4'b0101) && ~((pcard3 >= 4'b0100) && (pcard3 <= 4'b0111))) state <= 3'b111; // 5 -> 7 (dscore = 5, pcard3 not between 4,7)
else if((statewire == 3'b101) && (dscore == 4'b0100) && (pcard3 >= 4'b0010) && (pcard3 <= 4'b0111)) state <= 3'b110;    // 5 -> 6 (dscore = 4, pcard3 between 2,7)
else if((statewire == 3'b101) && (dscore == 4'b0100) && ~((pcard3 >= 4'b0010) && (pcard3 <= 4'b0111))) state <= 3'b111; // 5 -> 7 (dscore = 4, pcard3 not between 2,7)
else if((statewire == 3'b101) && (dscore == 4'b0011) && (pcard3 != 4'b1000)) state <= 3'b110;    // 5 -> 6 (dscore = 3, pcard3 not 8)
else if((statewire == 3'b101) && (dscore == 4'b0011) && ~(pcard3 != 4'b1000)) state <= 3'b111;   // 5 -> 7 (dscore = 3, pcard3 is 8)
else if((statewire == 3'b101) && (dscore <= 4'b0010)) state <= 3'b110;			 // 5 -> 6 (dscore <= 2)
